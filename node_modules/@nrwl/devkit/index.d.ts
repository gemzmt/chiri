...
export { WorkspaceJsonConfiguration, TargetDependencyConfig, TargetConfiguration, ProjectConfiguration, ProjectType, Generator, GeneratorCallback, Executor, ExecutorContext, Workspace, } from '@nrwl/tao/src/shared/workspace';
export { ImplicitDependencyEntry, ImplicitJsonSubsetDependency, NxJsonConfiguration, NxJsonProjectConfiguration, NxAffectedConfig, } from '@nrwl/tao/src/shared/nx';
export { logger } from '@nrwl/tao/src/shared/logger';
export { getPackageManagerCommand, PackageManager, } from '@nrwl/tao/src/shared/package-manager';
...
export { ProjectFileMap, FileData, ProjectGraph, ProjectGraphDependency, DependencyType, ProjectGraphNode, NxPlugin, ProjectGraphProcessorContext, } from './src/project-graph/interfaces';
