...
function installPackagesTask(host, alwaysRun = false, cwd = '', packageManager) {
    const packageJsonValue = host.read(path_2.joinPathFragments(cwd, 'package.json'), 'utf-8');
    if (host
        .listChanges()
        ...
        if (storedPackageJsonValue != packageJsonValue || alwaysRun) {
            storedPackageJsonValue = host.read(path_2.joinPathFragments(cwd, 'package.json'), 'utf-8');
